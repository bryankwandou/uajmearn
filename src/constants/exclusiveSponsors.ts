...
> = {
  ...
  pyth: {
    ...
    title: 'Pyth Network',
    description:
      'Explore the latest Research and Developer bounties for the Pyth Network ecosystem on UAJM Earn. Get started now!',
  },
  fundl: {
  ...
  tars: {
    ...
    title: 'Tars',
    description:
      'Explore the latest bounties for Tars on UAJM Earn. Get started now!',
  },
};
