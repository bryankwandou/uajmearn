      ...
      >
        ...
        >
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              UAJM Earn acts solely as a platform for the Partner to list
              contests, bounties, projects or similar engagements{' '}
              {`("Activities")`} on its platform {`("ST Earn Platform")`}.
            </li>
            <li>
              UAJM Earn shall not be liable for any Activities listed by
            ...
            <li>
              ...
              their own risk and discretion. UAJM Earn disclaims all
            ...
            <li>
              ...
              parties involved. UAJM Earn shall not be responsible for
              mediating or resolving such disputes.
            </li>
            <li>
              By using the platform and participating in any Activities, users
              agree to release UAJM Earn from any claims, liabilities, or
              damages arising from their participation in Activities listed by
              Partners.
            </li>
            <li>
              UAJM Earn does not guarantee the accuracy or legality of
            ...
            <li>
              ...
              hold UAJM Earn harmless from any claims, damages, or
