...
/**
 * Generate Organization schema for UAJM Earn
 */
...
export function generateRegionalOrganizationSchema(region: {
  ...
  return {
    '@context': 'https://schema.org',
    '@type': 'Organization',
    name: `UAJM Earn ${region.displayValue}`,
    url: `${baseUrl}earn/regions/${region.slug}/`,
    description: `UAJM Earn ${region.displayValue} - Discover bounties and grants in the ${region.displayValue} crypto community`,
  };
}
