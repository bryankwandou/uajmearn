    ...
    <Default
      meta={
        <Head>
          ...
          } by ${initialListing?.sponsor?.name} | UAJM Earn Listing`}</title>
          <meta
            name="description"
            content={`${getListingTypeLabel(initialListing?.type ?? 'Listing')} on UAJM Earn | ${
          ...
          <meta
            property="og:title"
            content={`${initialListing?.title || 'Listing'} | UAJM Earn`}
          />
          ...
          <meta
            ...
            content={`${initialListing?.title || 'Listing'} - ${initialListing?.type === 'bounty' ? 'Bounty' : 'Project'} by ${initialListing?.sponsor?.name || 'Sponsor'} on UAJM Earn`}
          />
