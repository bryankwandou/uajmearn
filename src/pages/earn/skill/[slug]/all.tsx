...
export default function AllSkillPage({
  ...
  const description =
    skillType === 'parent'
      ? `Explore all ${skillName} opportunities on UAJM Earn. Find bounties and projects that match your ${skillName.toLowerCase()} skills and start earning in crypto.`
      : `Discover all ${skillName} opportunities on UAJM Earn. Find specialized bounties and projects that require ${skillName.toLowerCase()} expertise.`;
  ...
  return (
    <Home
      ...
      meta={
        <>
          <Meta
            title={`All ${skillName} Opportunities | UAJM Earn`}
            description={description}
            canonical={`https://uajmearn.vercel.app/earn/skill/${slug}/all/`}
            og={ogImage.toString()}
          />
          <Head>
            ...
            <meta
              ...
              content={`All ${skillName} Opportunities on UAJM Earn`}
            />
