...
const SkillPage = ({
  ...
  const description =
    skillType === 'parent'
      ? `Explore ${skillName} opportunities on UAJM Earn. Find bounties and projects that match your ${skillName.toLowerCase()} skills and start earning in crypto.`
      : `Discover ${skillName} opportunities on UAJM Earn. Find specialized bounties and projects that require ${skillName.toLowerCase()} expertise.`;
        ...
        <>
          ...
          <Head>
            ...
            <meta
              ...
              content={`${skillName} Opportunities on UAJM Earn`}
            />
