...
export default function AllCategoryPage({
  ...
  const description = `Explore all ${categoryName.toLowerCase()} opportunities on UAJM Earn. ${categoryDescription}`;
        ...
        <>
          ...
          <Head>
            ...
            <meta
              ...
              content={`All ${categoryName} Opportunities on UAJM Earn`}
            />
