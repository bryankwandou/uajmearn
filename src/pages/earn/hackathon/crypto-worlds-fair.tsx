...
export default function CryptoWorldFair({
  ...
  return (
    <Default
      ...
      meta={
        <Meta
          title="Crypto World's Fair | UAJM Earn"
          description={hackathon.description}
          canonical="https://uajmearn.vercel.app/earn/hackathon/crypto-worlds-fair/"
          og={OG_IMAGE}
        />
      }
    >
...
const faqs: { question: string; answer: string }[] = [
  {
    ...
    answer:
      'Sidetracks are extra challenges hosted by UAJM Earn, separate from Colosseum’s Crypto World’s Fair tracks. They offer additional opportunities to build unique projects and win special prizes.',
  },
  {
    question: 'Do I need to submit separately to Sidetracks on UAJM Earn?',
    answer:
      'Yes! Sidetracks have their own submission process on UAJM Earn. Make sure you submit your project directly to each Sidetrack you wish to enter.',
  },
  {
