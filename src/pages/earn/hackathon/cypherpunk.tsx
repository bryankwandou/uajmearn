    ...
    <Default
      ...
      meta={
        <>
          ...
          />
          <Meta
            title="Cypherpunk | UAJM Earn"
            description={`Solana Cypherpunk Online Hackathon`}
            canonical="https://uajmearn.vercel.app/earn/hackathon/cypherpunk/"
...
const faqs: { question: string; answer: string }[] = [
  {
    ...
    answer:
      'Sidetracks are extra challenges hosted by UAJM Earn, separate from Colosseum’s Cypherpunk tracks. They offer additional opportunities to build unique projects and win special prizes.',
  },
  {
