...
<a style="color: blue" href="https://docs.google.com/spreadsheets/d/18Pahc-_9WhXezz7DW2kjwE1Iu-ExbOFtoxlPPsavsvg/edit?gid=0#gid=0" target="_blank">Click here</a> to access the Listings Menu, which contains ideas, listing examples, suggested prize ranges, etc.`,
      },
      {
        ...
        answer: `No! UAJM Earn is completely free to use. There are no listing or platform fees.`,
      },
      {
      ...
      },
      {
        ...
        answer: `When you publish a listing on UAJM Earn, it can be distributed across multiple high-visibility channels, including:
<br />
<br />
...
<br />
<strong>3. X:</strong> Listings with <strong>rewards over $1,000</strong> are amplified to reach a global audience via UAJM Earn's <a style="color: blue" href="http://x.com/superteamearn" target="_blank">X</a> profile.
<br />
